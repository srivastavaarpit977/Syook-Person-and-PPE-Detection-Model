...
def main(input_dir, output_dir, person_model_path, ppe_model_path):
    ...
    for img_name in os.listdir(input_dir):
        ...
        for result in person_results:    # Iterate through all images in the input directory
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inference script for person and PPE detection using YOLOv8 model")
    parser.add_argument('--input_dir', type=str, required=True, help="input images are in this directory.")
