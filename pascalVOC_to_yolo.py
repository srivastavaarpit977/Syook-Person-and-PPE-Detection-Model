...
def convert_pascal_voc_to_yolo(label_folder, output_folder):
    ...
    for label_file in os.listdir(label_folder):
        if label_file.endswith('.xml'):
            ...
            img_height = int(root.find('size/height').text)    # Iterate through all images in the input directory
...
def main():
    parser = argparse.ArgumentParser(description='Converting Pascal VOC annotations to YOLOv8 format')
